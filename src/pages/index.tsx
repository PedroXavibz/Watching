...
import { FaRegUserCircle as UserIcon, FaGithub as GithubIcon } from 'react-icons/fa';
          ...
          (
            <ModalLoad>
              <div className={styles.modalAvatar}>
                <Image width={128} height={128} src={user.img} alt='Avatar' />
              </div>
              ...
              <div className={styles.container__login__createRoom}>
                <div className={styles.container__login}>
                  ...
                  <form className={styles.form} onSubmit={submitSiginForm}>
                    ...
                    <Button title="Sign in" className={[styles.item, styles.btn].join(' ')} type="submit" onClick={() => submitSiginForm}>
                      Sign In
                    </Button>

                    <div className={[styles.socialSignin, styles.item].join(' ')}>
                      <Button title="Sign in with Google" className={styles.btnSocial} type="submit" onClick={() => signIn('google', { callbackUrl: '/room' })}>
                        <GoogleIcon /> Sign in with Google
                      </Button>

                      <Button title="Sign in with Github" className={styles.btnSocial} type="submit" onClick={() => signIn('github', { callbackUrl: '/room' })}>
                ...
                <div className={styles.container__createRoom}>
                  <div className={styles.createRoom}>
                    ...
                    <form className={styles.form} onSubmit={submitCreateRoom}>
                      ...
                      <Button title="Create Room" className={[styles.item, styles.btn].join(' ')} type="submit" onClick={() => submitCreateRoom}>
                        Create Room
                      </Button>
                    </form>
                  </div>
